...
Revision ID: e262ccafb4ed
Revises: 
Create Date: 2023-08-21 02:02:43.676173
...
def upgrade() -> None:
    ...
    sa.Column('leetcode_profile', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
