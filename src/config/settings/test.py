class Settings:
    ...
    # telegram group id of admins for accepting join group requests from users
    ADMINS_GROUP_ID: str
    ...
    TIME_CLEAN_LEFT_MEMBERS: (
        str
    )  # deleting info of users who left the group from database
